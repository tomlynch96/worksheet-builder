...
export function LibraryPreviewPage() {
  ...
  // Reallocation state — shown when teacher doesn't teach the worksheet's course
          ...
          {!teachesThisCourse && !showReallocate && (
            <div className="lp-mismatch-notice">
              <p className="lp-mismatch-text">
                This worksheet is tagged to a course you don't teach. You can still copy it — you'll need to reassign it to one of your courses.
              </p>
            </div>
          )}
